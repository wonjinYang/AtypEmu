...
PLAN_CANONICAL_SHA256 = (
    "d6f0c54c0a050f5f0ef529c84efbab62cc19c4d4b8e0378de5a7751019efa781"
)
...
SAFE_EVIDENCE = {
    ...
    "all_atom_recount_checker": {
        ...
        "sha256": "eb2171cb3ebf5942e86d2152ddd81cb40f210806e73ecb0a0057a8deb91107c6",
    },
...
def main() -> int:
    ...
    from check_condition_uncertainty_protonation_plan import (
        verify as verify_condition_uncertainty_protonation_plan,
    )
    ...
    from openmm86_unique_assigned_ph_v1_recovery_v2 import (
    ...
    condition_uncertainty_support_checks = (
        verify_condition_uncertainty_protonation_plan(run_self_test=args.self_test)
    )
    ...
    openmm86_unique_assigned_ph_v1_recovery_v2_checks = (
        openmm86_unique_assigned_ph_v1_recovery_v2_self_test()
        if args.self_test
        else 0
    )
    openmm86_unique_assigned_ph_v1_recovery_v3_checks = (
        openmm86_unique_assigned_ph_v1_recovery_v3_self_test()
        if args.self_test
        else 0
    )
